...
export const defaultChartOfAccounts: ChartOfAccountsItemDefinition[] = [
  // == ASSETS (1000-1999) ==
  {
    code: "1000",
    name: "Current Assets",
    type: "asset" as AccountTypeFromSchema,
    normalBalance: "debit",
    description: "Top-level current assets category.",
  },
  {
    code: "1010",
    ...
    parentCode: "1000",
    normalBalance: "debit",
    description: "Operating bank accounts, petty cash.",
  },
  {
    code: "1020",
...

  {
    ...
    normalBalance: "debit",
    description: "Amounts due from tenants for rent.",
  },
  {
    code: "1110",
...

  {
    ...
    parentCode: "1000",
    normalBalance: "debit",
    description: "Expenses paid in advance, like insurance.",
  },
  {
    code: "1210",
  ...
  {
    code: "1300",
    name: "Security Deposits Held (Asset)",
    type: "asset" as AccountTypeFromSchema,
    parentCode: "1000",
    normalBalance: "debit",
    description:
      "Cash held in a separate bank account for tenant security deposits. A corresponding liability exists.",
  },

  {
    ...
    type: "asset" as AccountTypeFromSchema,
    normalBalance: "debit",
    description: "Long-term assets like land and buildings.",
  },
  {
    code: "1510",
    name: "Land",
  ...
  },
  {
    ...
    description: "Contra-asset account for building depreciation.",
  },
  {
    code: "1530",
  ...
  // == LIABILITIES (2000-2999) ==
  {
    ...
    type: "liability" as AccountTypeFromSchema,
    normalBalance: "credit",
  ...
  {
    code: "2100",
    name: "Tenant Security Deposits (Liability)",
    type: "liability" as AccountTypeFromSchema,
    parentCode: "2000",
    normalBalance: "credit",
    description: "Obligation to return security deposits to tenants.",
  },
  {
    code: "2200",
    ...
    parentCode: "2000",
    normalBalance: "credit",
    description: "Rent received from tenants in advance.",
  },
  {
    code: "2300",
...

  {
    ...
    type: "liability" as AccountTypeFromSchema,
    normalBalance: "credit",
    description: "Obligations due in more than one year.",
  },
  {
    code: "2510",
  ...
  // == EQUITY (3000-3999) ==
  {
    code: "3000",
    name: "Equity",
    type: "equity" as AccountTypeFromSchema,
    normalBalance: "credit",
    description: "Owner's stake in the company.",
  },
  {
    code: "3010",
    name: "Owner's Capital / Common Stock",
    type: "equity" as AccountTypeFromSchema,
    parentCode: "3000",
    normalBalance: "credit",
  },
  {
    ...
    parentCode: "3000",
    normalBalance: "debit",
    description: "Withdrawals by the owner or dividends paid (contra-equity).",
  },
  {
    code: "3030",
  ...
  // == INCOME / REVENUE (4000-4999) ==
  {
    ...
    type: "income" as AccountTypeFromSchema,
    normalBalance: "credit",
  ...
  },
  {
    ...
    parentCode: "4000",
    normalBalance: "credit",
    description: "e.g., laundry, parking fees.",
  },

  {
    ...
    type: "income" as AccountTypeFromSchema,
    normalBalance: "credit",
    description: "Income from secondary activities.",
  },
  {
    code: "4510",
  ...
  // == EXPENSES (5000-5999) ==
  {
    ...
    type: "expense" as AccountTypeFromSchema,
    normalBalance: "debit",
    description: "Expenses directly related to property operations.",
  },
  {
    code: "5010",
    ...
    type: "expense" as AccountTypeFromSchema,
    parentCode: "5000",
    subtype: "non-recoverable" as TypeExpenseSubtype,
    isRecoverable: false,
    normalBalance: "debit",
  },
  {
    code: "5011",
    name: "Property Management Fees (Recoverable)",
    type: "expense" as AccountTypeFromSchema,
    parentCode: "5000",
    subtype: "recoverable" as TypeExpenseSubtype,
    isRecoverable: true,
    normalBalance: "debit",
  },
  {
  ...
  {
    code: "5021",
    name: "Repairs and Maintenance (Recoverable)",
    type: "expense" as AccountTypeFromSchema,
    parentCode: "5000",
    subtype: "recoverable" as TypeExpenseSubtype,
    isRecoverable: true,
  ...
  {
    code: "5920",
    name: "Depreciation Expense - Furniture & Fixtures",
    type: "expense" as AccountTypeFromSchema,
    parentCode: "5900",
    normalBalance: "debit",
  },
  {
    code: "5930",
    name: "Amortization Expense - Loan Costs",
    type: "expense" as AccountTypeFromSchema,
    parentCode: "5900",
    normalBalance: "debit",
  },
...
export function findAccountByCodeInList(
  chart: ChartOfAccountsItemDefinition[],
  code: string
): ChartOfAccountsItemDefinition | undefined {
  return chart.find((account) => account.code === code);
}

export interface HierarchicalChartOfAccountsItem
  extends ChartOfAccountsItemDefinition {
...
export function buildDefaultCoAHierarchy(
  ...
  for (const item of items) {
    const itemParentCode =
      item.parentCode === undefined ? null : item.parentCode;
